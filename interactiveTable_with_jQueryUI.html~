...
$(function() {
  ...
  //Configure the slider options so that each slider has values between 0-99. 
  var sliderOpts = {
      min:0,
      max: 99,
      animate: true,
  ...
  //Validate Form 
  $('#myForm').validate({
      //Rules: Mulipliers and Multiplicands are required and must be numbers less than 100. 
      rules : {
        multiplier1 : {
          required : true,
          number : true, 
  ...
  var form = dialog.find( "form" ).submit(function( event ) {
    //When the user presses the submit button, validate the form, add the tab, and then close the dialog box containing the form.   
    addTab();
    dialog.dialog( "close" );
  ...
  function addTab() {
      ...
      multiplierHtml = "The multipliers you entered are: " + a + " and " + b; 
      multiplicandsHtml = "The multiplicands you entered are: " + c + " and " + d; 

      //Check to see if multiplicand1 is less than multiplicand2, if so swap them. 
      if(a > b){
          multiplierAlertHtml = "<br>" + " Multiplier 1 was larger than Multiplier 2, so there values were swapped on the table. " + "<br>" ;
          var temp1;
          temp1 = a;
          a = b;
          b = temp1;
      ...
      if(c > d){
          multiplicandAlertHtml = "<br>" + " Multiplicand 1 was larger than Multiplicand 2, so there values were swapped on the table. " + "<br>" ;
          var temp2;
          temp2 = c;
          c = d;
          d = temp2;
     ...
     tabs.append( "<div id='" + id + "'><p>" + multiplierAlertHtml + multiplicandAlertHtml + "<br>" + multiplierHtml + "<br><br>" + multiplicandsHtml + "<br><br>" +  "</p></div>" );
